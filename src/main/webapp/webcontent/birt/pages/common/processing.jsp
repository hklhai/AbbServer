...
<HTML>
	<HEAD>
        ...
        <LINK REL="stylesheet" HREF="<%=Context%>/webcontent/birt/styles/button.css" TYPE="text/css">
        <LINK REL="stylesheet" HREF="<%=Context%>/webcontent/birt/styles/label_badge.css" TYPE="text/css">
        <LINK REL="stylesheet" HREF="<%=Context%>/webcontent/birt/styles/icon.css" TYPE="text/css">
