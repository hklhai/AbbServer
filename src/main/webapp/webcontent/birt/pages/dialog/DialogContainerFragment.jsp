				...
				<div class="dialogBtnBar">
					<div id="<%= fragment.getClientId( ) %>dialogCustomButtonContainer" class="dialogBtnBarButtonContainer">
						<div id="<%= fragment.getClientId( ) %>okButton">
							...
							<input type="button" value="<%= BirtResources.getHtmlMessage( "birt.viewer.dialog.ok" ) %>" title="<%= BirtResources.getHtmlMessage( "birt.viewer.dialog.ok" ) %>" class="btn btn-sm btn-primary"/>
						</div>
						...
						<div id="<%= fragment.getClientId( ) %>cancelButton">
							...
							<input type="button" value="<%= BirtResources.getHtmlMessage( "birt.viewer.dialog.cancel" )%>" title="<%= BirtResources.getHtmlMessage( "birt.viewer.dialog.cancel" )%>" class="btn btn-sm"/>
						</div> 
					</div>							
				</div>
			</div>
