...
<HTML lang="<%= attributeBean.getLanguage() %>">
	<HEAD>
        ...
        <LINK REL="stylesheet" HREF="birt/styles/button.css" TYPE="text/css">
        <LINK REL="stylesheet" HREF="birt/styles/label_badge.css" TYPE="text/css">
        <LINK REL="stylesheet" HREF="birt/styles/icon.css" TYPE="text/css">
