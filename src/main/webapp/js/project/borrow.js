    ...
    commonList.prototype = {
        ...
        initBind:function(){
            ...
            $(".mylable button.myform").click(function(){
                var dataId=0;
                window.location.href =  _ctx + "/project/detail?apptname="+apptnames+"&pkid="+dataId+"&operate=add";
            });
            //收藏
            ...
            $("table.mytable tbody").on("click","tr:not(:nth-child(1))",function(){
                ...
                window.location.href =  _ctx + "/project/detail?apptname="+apptnames+"&pkid="+dataId+"&operate=details";
            });
            //page按钮
