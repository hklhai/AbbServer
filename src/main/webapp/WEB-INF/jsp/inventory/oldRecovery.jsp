...
<div class="borrow-detail">
    <%--<h4>旧料回收</h4>--%>
        <div class="tab-btn">
            ...
            <button class="workOrder click">旧料回收</button>
        </div>
    ...
    <div class="row detail">
        ...
        <div class="row-info">
            ...
            <div class="layout">
                ...
                <p class="item" style="width:40%;">
                    <label for="">物资:</label>
                    <input type="text"  class="itemnum SELECTIONINVENTORY" style="width: 120px;">
        ...
        <div class="row-info">
            ...
            <div class="layout">
                <p class="item">
                    ...
                    <input type="text" class="enterdate datetimepicker7" id="">
                </p>
                <p class="item">
                    <label for="">收货方:</label>
