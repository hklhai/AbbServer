...
/**
 * Created by fuyg on 2017-10-18.
 */
@Entity
@Table(name="UDSCENESERVICENOTIFY")
@DynamicUpdate
public class Udsceneservicenotify implements Serializable {
  private static final long serialVersionUID = 1L;
  @Id
  @SequenceGenerator(name="UDSCENESERVICENOTIFY_UDID_GENERATOR", allocationSize = 1 , sequenceName="UDIDSEQ")
  @GeneratedValue(strategy= GenerationType.SEQUENCE, generator="UDSCENESERVICENOTIFY_UDID_GENERATOR")
  private Long udid;
