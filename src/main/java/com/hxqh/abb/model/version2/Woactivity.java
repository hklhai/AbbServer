...
public class Woactivity implements Serializable {
	...
	private BigDecimal estIntegerlabcost;
	...
	public BigDecimal getEstatapprIntegerlabcost() {
		return this.estatapprIntegerlabcost;
	}

	public void setEstatapprIntegerlabcost(BigDecimal estatapprIntegerlabcost) {
		this.estatapprIntegerlabcost = estatapprIntegerlabcost;
	}
	...
	public BigDecimal getEstIntegerlabcost() {
		return this.estIntegerlabcost;
	}

	public void setEstIntegerlabcost(BigDecimal estIntegerlabcost) {
	...
	public Date getFnlconstraInteger() {
		return this.fnlconstraInteger;
	}

	public void setFnlconstraInteger(Date fnlconstraInteger) {
		this.fnlconstraInteger = fnlconstraInteger;
	}
	...
	public String getPoIntegernum() {
		return this.poIntegernum;
	}

	public void setPoIntegernum(String poIntegernum) {
		this.poIntegernum = poIntegernum;
	}
	...
	public Date getSneconstraInteger() {
		return this.sneconstraInteger;
	}

	public void setSneconstraInteger(Date sneconstraInteger) {
		this.sneconstraInteger = sneconstraInteger;
	}
