...
public class Labtran implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "LABTRANS_LABTRANSID_GENERATOR", allocationSize = 1, sequenceName = "LABTRANSSEQ")
    ...
    public String getDaterstatus() {
        return this.timerstatus;
    }

    public void setDaterstatus(String timerstatus) {
        this.timerstatus = timerstatus;
    }
