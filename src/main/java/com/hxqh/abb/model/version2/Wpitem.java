...
/**
 * The persistent class for the WPITEM database table.
 * 
 */
@Entity
@Table(name = "Wpitem")
public class Wpitem implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="WPITEM_WPITEMID_GENERATOR", sequenceName="WPITEMSEQ")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="WPITEM_WPITEMID_GENERATOR")
	...
	private int unitcosthaschanged;
	...
	public int getDirectreq() {
		return this.directreq;
	}

	public void setDirectreq(int directreq) {
	...
	public int getMktplcitem() {
		return this.mktplcitem;
	}

	public void setMktplcitem(int mktplcitem) {
	...
	public int getPrlinenum() {
		return this.prlinenum;
	}

	public void setPrlinenum(int prlinenum) {
	...
	public int getUnitcosthaschanged() {
		return this.unitcosthaschanged;
	}

	public void setUnitcosthaschanged(int unitcosthaschanged) {
